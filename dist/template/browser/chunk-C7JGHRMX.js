...
var CourseService = class _CourseService {
  ...
  saveArticleContent(lessonId, content) {
    return this.http.put(`${this.apiUrl}/instructor/courses/lessons/${lessonId}/article`, { content });
  }
  ...
  saveProgress(lessonId, watchedSeconds) {
    return this.http.put(`${this.apiUrl}/student/progress/lesson/${lessonId}`, { watchedSeconds });
  }
  ...
  adminUpdatePrice(courseId, price) {
    return this.http.put(`${this.apiUrl}/admin/courses/${courseId}/price`, { price });
  }
  /** Admin: mettre un cours en promotion */
  adminSetPromotion(courseId, discountPrice, discountEndsAt) {
    return this.http.put(`${this.apiUrl}/admin/courses/${courseId}/promotion`, { discountPrice, discountEndsAt });
  }
  ...
  toggleFeatured(courseId, featured) {
    return this.http.put(`${this.apiUrl}/admin/courses/${courseId}/featured`, { featured });
  }
  ...
  rejectPendingEdit(courseId, reason) {
    return this.http.put(`${this.apiUrl}/admin/courses/${courseId}/reject-edit`, { reason });
  }
  ...
  createCheckoutSession(courseId) {
    return this.http.post(`${this.apiUrl}/payment/create-session`, { courseId });
  }
...
//# sourceMappingURL=chunk-C7JGHRMX.js.map
