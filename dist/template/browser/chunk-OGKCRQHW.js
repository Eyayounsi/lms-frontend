...
var LightGallery = (
  ...
  (function() {
    ...
    LightGallery2.prototype.generateSettings = function(options) {
      this.settings = __assign3(__assign3({}, lightGalleryCoreSettings), options);
      if (this.settings.isMobile && typeof this.settings.isMobile === "function" ? this.settings.isMobile() : utils.isMobile()) {
        var mobileSettings = __assign3(__assign3({}, this.settings.mobileSettings), this.settings.mobileSettings);
        this.settings = __assign3(__assign3({}, this.settings), mobileSettings);
      }
    };
    ...
    LightGallery2.prototype.init = function() {
      ...
      this.buildStructure();
      this.LGel.trigger(lGEvents3.init, {
        instance: this
      });
    ...
    LightGallery2.prototype.refreshOnResize = function() {
      if (this.lgOpened) {
        ...
        this.LGel.trigger(lGEvents3.containerResize);
      }
    };
    ...
    LightGallery2.prototype.updateSlides = function(items, index) {
      ...
      this.LGel.trigger(lGEvents3.updateSlides);
    };
    ...
    LightGallery2.prototype.openGallery = function(index, element) {
      ...
      this.index = index;
      this.LGel.trigger(lGEvents3.beforeOpen);
      ...
      setTimeout(function() {
        ...
        _this.LGel.trigger(lGEvents3.afterOpen);
      });
      if (document.body === this.settings.container) {
    ...
    LightGallery2.prototype.addHtml = function(index) {
      ...
      this.LGel.trigger(lGEvents3.afterAppendSubHtml, {
        index
      });
    };
    ...
    LightGallery2.prototype.triggerSlideItemLoad = function($currentSlide, index, delay, speed, isFirstSlide) {
      ...
      setTimeout(function() {
        $currentSlide.addClass("lg-complete lg-complete_");
        _this.LGel.trigger(lGEvents3.slideItemLoad, {
          index,
          delay: delay || 0,
          isFirstSlide
        });
    ...
    LightGallery2.prototype.loadContent = function(index, rec) {
      ...
      if (!$currentSlide.hasClass("lg-loaded")) {
        ...
        if (poster || videoInfo) {
          this.LGel.trigger(lGEvents3.hasVideo, {
            index,
            src,
        ...
        this.LGel.trigger(lGEvents3.afterAppendSlide, { index });
    ...
    LightGallery2.prototype.slide = function(index, fromTouch, fromThumb, direction) {
      ...
      if (!this.lgBusy) {
        ...
        this.LGel.trigger(lGEvents3.beforeSlide, {
          prevIndex,
          index,
          fromTouch: !!fromTouch,
          fromThumb: !!fromThumb
        ...
        setTimeout(function() {
          ...
          _this.LGel.trigger(lGEvents3.afterSlide, {
            prevIndex,
            index,
            fromTouch,
            fromThumb
      ...
      setTimeout(function() {
        ...
        if (triggerClick && Math.abs(endCoords.pageX - startCoords.pageX) < 5) {
          ...
          if (_this.isPosterElement(target)) {
            _this.LGel.trigger(lGEvents3.posterClick);
          }
        }
      ...
      if (this.settings.enableDrag) {
          ...
          if ($LG(e.target).hasClass("lg-item") || $item.get().contains(e.target)) {
            if (!_this.outer.hasClass("lg-zoomed") && !_this.lgBusy) {
              ...
              if (!_this.lgBusy) {
                ...
                _this.LGel.trigger(lGEvents3.dragStart);
              }
            }
          }
        });
        $LG(window).on("mousemove.lg.global" + this.lgId, function(e) {
          if (isDraging && _this.lgOpened) {
            ...
            _this.LGel.trigger(lGEvents3.dragMove);
          }
        });
        $LG(window).on("mouseup.lg.global" + this.lgId, function(event) {
          ...
          if (isMoved) {
            isMoved = false;
            _this.touchEnd(endCoords, startCoords, event);
            _this.LGel.trigger(lGEvents3.dragEnd);
    ...
    LightGallery2.prototype.goToNextSlide = function(fromTouch) {
      ...
      if (!this.lgBusy) {
        if (this.index + 1 < this.galleryItems.length) {
          this.index++;
          this.LGel.trigger(lGEvents3.beforeNextSlide, {
            index: this.index
          });
    ...
    LightGallery2.prototype.goToPrevSlide = function(fromTouch) {
      ...
      if (!this.lgBusy) {
        if (this.index > 0) {
          this.index--;
          this.LGel.trigger(lGEvents3.beforePrevSlide, {
            index: this.index,
            fromTouch
          });
    ...
    LightGallery2.prototype.closeGallery = function(force) {
      ...
      this.LGel.trigger(lGEvents3.beforeClose);
      ...
      setTimeout(function() {
        ...
        _this.$inner.empty();
        if (_this.lgOpened) {
          _this.LGel.trigger(lGEvents3.afterClose, {
            instance: _this
          });
        }
...
lightgallery/lightgallery.es5.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-OGKCRQHW.js.map
