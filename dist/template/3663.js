(self["webpackChunktemplate"] = self["webpackChunktemplate"] || []).push([[3663],{
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  iframeUtils = __webpack_require__(/*! ../../utils/iframe */ 93766),
  urlUtils = __webpack_require__(/*! ../../utils/url */ 89845),
  EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  random = __webpack_require__(/*! ../../utils/random */ 15633);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:receiver:htmlfile');
}
...
var iframeUtils = __webpack_require__(/*! ./utils/iframe */ 93766);
...
var EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  inherits = __webpack_require__(/*! inherits */ 19822),
  eventUtils = __webpack_require__(/*! ../../utils/event */ 65288),
  browser = __webpack_require__(/*! ../../utils/browser */ 53368),
  urlUtils = __webpack_require__(/*! ../../utils/url */ 89845);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:sender:xdr');
}
...
__webpack_require__(/*! ./transport/websocket */ 97079), __webpack_require__(/*! ./transport/xhr-streaming */ 49063), __webpack_require__(/*! ./transport/xdr-streaming */ 10859), __webpack_require__(/*! ./transport/eventsource */ 56813), __webpack_require__(/*! ./transport/lib/iframe-wrap */ 28515)(__webpack_require__(/*! ./transport/eventsource */ 56813))

// polling transports
, __webpack_require__(/*! ./transport/htmlfile */ 95193), __webpack_require__(/*! ./transport/lib/iframe-wrap */ 28515)(__webpack_require__(/*! ./transport/htmlfile */ 95193)), __webpack_require__(/*! ./transport/xhr-polling */ 82520), __webpack_require__(/*! ./transport/xdr-polling */ 56700), __webpack_require__(/*! ./transport/lib/iframe-wrap */ 28515)(__webpack_require__(/*! ./transport/xhr-polling */ 82520)), __webpack_require__(/*! ./transport/jsonp-polling */ 51020)];
...
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:receiver:xhr');
}
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  AjaxBasedTransport = __webpack_require__(/*! ./lib/ajax-based */ 63270),
  XhrReceiver = __webpack_require__(/*! ./receiver/xhr */ 10438),
  XDRObject = __webpack_require__(/*! ./sender/xdr */ 7382);
...
function setup(env) {
  ...
  createDebug.humanize = __webpack_require__(/*! ms */ 65269);
...
var crypto = __webpack_require__(/*! crypto */ 90932);
...
var transportList = __webpack_require__(/*! ./transport-list */ 7788);
module.exports = __webpack_require__(/*! ./main */ 91381)(transportList);
...
var required = __webpack_require__(/*! requires-port */ 25979),
  qs = __webpack_require__(/*! querystringify */ 77308),
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  IframeTransport = __webpack_require__(/*! ../iframe */ 82170),
  objectUtils = __webpack_require__(/*! ../../utils/object */ 26601);
...
let NotificationService = /*#__PURE__*/(() => {
  class NotificationService {
    ...
    getUnreadCount() {
      return this.http.get(`${this.api}/notifications/unread-count`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.map)(res => res.count));
    }
    markAsRead(id) {
    ...
    getUnreadMessageCount() {
      return this.http.get(`${this.api}/user/messages/unread-count`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.map)(res => res.count ?? 0));
    }
    static ɵfac = function NotificationService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || NotificationService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient));
    };
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  Event = __webpack_require__(/*! ./event */ 38337);
function CloseEvent() {
  Event.call(this);
...
/***/ 42626:
/*!*******************************************************************************!*\
  !*** ./src/app/shared/service/notification/websocket-notification.service.ts ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WebSocketNotificationService: () => (/* binding */ WebSocketNotificationService)
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ 75797);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../environments/environment */ 45312);
/* harmony import */ var sockjs_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! sockjs-client */ 19550);
...
/* harmony import */ var _stomp_stompjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @stomp/stompjs */ 85215);
 ...
 * }
 */
let WebSocketNotificationService = /*#__PURE__*/(() => {
  class WebSocketNotificationService {
    toastr;
    ngZone;
    stompClient = null;
    notificationsSubscription = null;
    newNotificationsSubject = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(null);
    connectedSubject = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(false);
    constructor(toastr, ngZone) {
      this.toastr = toastr;
      this.ngZone = ngZone;
    ...
    initializeWebSocket() {
      ...
      try {
        ...
        const baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.apiUrl.replace(/\/api\/?$/, '').replace(/\/$/, '');
        const wsUrl = token ? `${baseUrl}/ws?token=${encodeURIComponent(token)}` : `${baseUrl}/ws`;
        this.stompClient = new _stomp_stompjs__WEBPACK_IMPORTED_MODULE_3__.Client({
          webSocketFactory: () => new (sockjs_client__WEBPACK_IMPORTED_MODULE_2___default())(wsUrl),
          reconnectDelay: 5000,
          debug: () => {
    ...
    connect() {
      ...
      client.onConnect = frame => {
        ...
        this.notificationsSubscription = client.subscribe('/user/queue/notifications', message => {
          try {
    ...
    static ɵfac = function WebSocketNotificationService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || WebSocketNotificationService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_6__.ToastrService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgZone));
    };
    static ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
      token: WebSocketNotificationService,
      factory: WebSocketNotificationService.ɵfac,
      providedIn: 'root'
    });
  }
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  XhrDriver = __webpack_require__(/*! ../driver/xhr */ 67962);
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  AjaxBasedTransport = __webpack_require__(/*! ./lib/ajax-based */ 63270),
  XhrReceiver = __webpack_require__(/*! ./receiver/xhr */ 10438),
  XHRCorsObject = __webpack_require__(/*! ./sender/xhr-cors */ 59086),
  XHRLocalObject = __webpack_require__(/*! ./sender/xhr-local */ 47724),
  browser = __webpack_require__(/*! ../utils/browser */ 53368);
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  SenderReceiver = __webpack_require__(/*! ./lib/sender-receiver */ 76301),
  JsonpReceiver = __webpack_require__(/*! ./receiver/jsonp */ 93674),
  jsonpSender = __webpack_require__(/*! ./sender/jsonp */ 70606);
...
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:buffered-sender');
}
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  XHRLocalObject = __webpack_require__(/*! ./transport/sender/xhr-local */ 47724),
  InfoAjax = __webpack_require__(/*! ./info-ajax */ 54587);
...
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:info-ajax');
}
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  AjaxBasedTransport = __webpack_require__(/*! ./lib/ajax-based */ 63270),
  XdrStreamingTransport = __webpack_require__(/*! ./xdr-streaming */ 10859),
  XhrReceiver = __webpack_require__(/*! ./receiver/xhr */ 10438),
  XDRObject = __webpack_require__(/*! ./sender/xdr */ 7382);
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  AjaxBasedTransport = __webpack_require__(/*! ./lib/ajax-based */ 63270),
  EventSourceReceiver = __webpack_require__(/*! ./receiver/eventsource */ 77237),
  XHRCorsObject = __webpack_require__(/*! ./sender/xhr-cors */ 59086),
  EventSourceDriver = __webpack_require__(/*! eventsource */ 38254);
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  urlUtils = __webpack_require__(/*! ../../utils/url */ 89845),
  SenderReceiver = __webpack_require__(/*! ./sender-receiver */ 76301);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:ajax-based');
}
...
var random = __webpack_require__(/*! ./random */ 15633);
var onUnload = {},
  afterUnload = false
...
var urlUtils = __webpack_require__(/*! ./utils/url */ 89845),
  eventUtils = __webpack_require__(/*! ./utils/event */ 65288),
  FacadeJS = __webpack_require__(/*! ./facade */ 3058),
  InfoIframeReceiver = __webpack_require__(/*! ./info-iframe-receiver */ 53523),
  iframeUtils = __webpack_require__(/*! ./utils/iframe */ 93766),
  loc = __webpack_require__(/*! ./location */ 43747);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:iframe-bootstrap');
}
...
var EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  inherits = __webpack_require__(/*! inherits */ 19822),
  utils = __webpack_require__(/*! ../../utils/event */ 65288),
  urlUtils = __webpack_require__(/*! ../../utils/url */ 89845),
  XHR = global.XMLHttpRequest;
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:browser:xhr');
}
...
var random = __webpack_require__(/*! ../../utils/random */ 15633),
  urlUtils = __webpack_require__(/*! ../../utils/url */ 89845);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:sender:jsonp');
}
var form, area;
...
var EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  inherits = __webpack_require__(/*! inherits */ 19822),
  utils = __webpack_require__(/*! ./utils/event */ 65288),
  IframeTransport = __webpack_require__(/*! ./transport/iframe */ 82170),
  InfoReceiverIframe = __webpack_require__(/*! ./info-iframe-receiver */ 53523);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:info-iframe');
}
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  urlUtils = __webpack_require__(/*! ../../utils/url */ 89845),
  BufferedSender = __webpack_require__(/*! ./buffered-sender */ 51119),
  Polling = __webpack_require__(/*! ./polling */ 86915);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:sender-receiver');
}
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  EventTarget = __webpack_require__(/*! ./eventtarget */ 21172);
...
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:receiver:eventsource');
}
...
module.exports = __webpack_require__(/*! ./common */ 14007)(exports);
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  version = __webpack_require__(/*! ../version */ 99350),
  urlUtils = __webpack_require__(/*! ../utils/url */ 89845),
  iframeUtils = __webpack_require__(/*! ../utils/iframe */ 93766),
  eventUtils = __webpack_require__(/*! ../utils/event */ 65288),
  random = __webpack_require__(/*! ../utils/random */ 15633);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:transport:iframe');
}
...
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:polling');
}
...
var URL = __webpack_require__(/*! url-parse */ 23028);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:utils:url');
}
module.exports = {
...
__webpack_require__(/*! ./shims */ 9920);
var URL = __webpack_require__(/*! url-parse */ 23028),
  inherits = __webpack_require__(/*! inherits */ 19822),
  random = __webpack_require__(/*! ./utils/random */ 15633),
  escape = __webpack_require__(/*! ./utils/escape */ 14717),
  urlUtils = __webpack_require__(/*! ./utils/url */ 89845),
  eventUtils = __webpack_require__(/*! ./utils/event */ 65288),
  transport = __webpack_require__(/*! ./utils/transport */ 98305),
  objectUtils = __webpack_require__(/*! ./utils/object */ 26601),
  browser = __webpack_require__(/*! ./utils/browser */ 53368),
  log = __webpack_require__(/*! ./utils/log */ 2358),
  Event = __webpack_require__(/*! ./event/event */ 38337),
  EventTarget = __webpack_require__(/*! ./event/eventtarget */ 21172),
  loc = __webpack_require__(/*! ./location */ 43747),
  CloseEvent = __webpack_require__(/*! ./event/close */ 31825),
  TransportMessageEvent = __webpack_require__(/*! ./event/trans-message */ 63397),
  InfoReceiver = __webpack_require__(/*! ./info-receiver */ 92264);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:main');
}
var transports;
...
SockJS.version = __webpack_require__(/*! ./version */ 99350);
SockJS.CONNECTING = 0;
SockJS.OPEN = 1;
SockJS.CLOSING = 2;
SockJS.CLOSED = 3;
...
module.exports = function (availableTransports) {
  ...
  __webpack_require__(/*! ./iframe-bootstrap */ 66475)(SockJS, availableTransports);
  return SockJS;
};
...
var EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  inherits = __webpack_require__(/*! inherits */ 19822),
  urlUtils = __webpack_require__(/*! ./utils/url */ 89845),
  XDR = __webpack_require__(/*! ./transport/sender/xdr */ 7382),
  XHRCors = __webpack_require__(/*! ./transport/sender/xhr-cors */ 59086),
  XHRLocal = __webpack_require__(/*! ./transport/sender/xhr-local */ 47724),
  XHRFake = __webpack_require__(/*! ./transport/sender/xhr-fake */ 30830),
  InfoIframe = __webpack_require__(/*! ./info-iframe */ 74513),
  InfoAjax = __webpack_require__(/*! ./info-ajax */ 54587);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:info-receiver');
}
...
var utils = __webpack_require__(/*! ../../utils/iframe */ 93766),
  random = __webpack_require__(/*! ../../utils/random */ 15633),
  browser = __webpack_require__(/*! ../../utils/browser */ 53368),
  urlUtils = __webpack_require__(/*! ../../utils/url */ 89845),
  inherits = __webpack_require__(/*! inherits */ 19822),
...
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:receiver:jsonp');
}
...
var eventUtils = __webpack_require__(/*! ./event */ 65288),
  browser = __webpack_require__(/*! ./browser */ 53368);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:utils:iframe');
}
module.exports = {
  WPrefix: '_jp',
...
var inherits = __webpack_require__(/*! inherits */ 19822),
  HtmlfileReceiver = __webpack_require__(/*! ./receiver/htmlfile */ 1569),
  XHRLocalObject = __webpack_require__(/*! ./sender/xhr-local */ 47724),
  AjaxBasedTransport = __webpack_require__(/*! ./lib/ajax-based */ 63270);
...
var utils = __webpack_require__(/*! ../utils/event */ 65288),
  urlUtils = __webpack_require__(/*! ../utils/url */ 89845),
  inherits = __webpack_require__(/*! inherits */ 19822),
  EventEmitter = (__webpack_require__(/*! events */ 76439).EventEmitter),
  WebsocketDriver = __webpack_require__(/*! ./driver/websocket */ 83452);
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:websocket');
}
...
var debug = function () {};
if (true) {
  debug = __webpack_require__(/*! debug */ 80776)('sockjs-client:utils:transport');
}
module.exports = function (availableTransports) {
  return {
